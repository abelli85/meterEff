...
select meterId, meterName from bw_meter where to_tsvector('parser_name', meterName) @@ '福州';
select meterId, meterName from bw_meter where to_tsvector('parser_name', meterName) @@ to_tsquery('parser_name', '福州|福州');
select meterId, meterName from bw_meter where to_tsvector('parser_name', meterName) @@ to_tsquery('parser_name', '中国福州');
select meterId, meterName from bw_meter where to_tsvector('parser_name', meterName) @@ to_tsquery('parser_name', '福州|中国|花园');
select meterId, meterName from bw_meter where to_tsvector('parser_name', meterName) @@ to_tsquery('parser_name', '福州&公司');
