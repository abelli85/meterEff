...
class StatServiceTest {
    companion object {
        ...
        private val lgr = LoggerFactory.getLogger(StatServiceTest::class.java)
    }
    ...
    fun testStatMeter() {
        ...
        val post = HttpPost(TestHelper.URL_BASE + StatService.BASE_PATH + StatService.PATH_STAT_METER).apply {
