 ...
 */
class MeterMonthFlow : MeterBaseFlow() {
    init {
        // 一天时间
        duration = 86400 * 30
    }
    ...
    /** 周日均水量, m³ */
    var monthDailyAvg: Double? = null
    /** 周日方差, m³ */
    var monthDailyError: Double? = null

    /** 周的日最小水量，m³ */
    var monthDailyMin: Double? = null

    /** 周最小水量的日*/
    @JsonSerialize(using = JsonDateSerializer::class)
    @JsonDeserialize(using = JsonDateDeserializer::class)
    @JSONField(format = JsonHelper.FULL_DATE_FORMAT)
    var monthDailyMinDay: Date? = null

    /** 周的日最大水量, m³ */
    var monthDailyMax: Double? = null

    /** 周最大水量的日*/
    @JsonSerialize(using = JsonDateSerializer::class)
    @JsonDeserialize(using = JsonDateDeserializer::class)
    @JSONField(format = JsonHelper.FULL_DATE_FORMAT)
    var monthDailyMaxDay: Date? = null

    /** 去年同周的日水量，m³ */
    var lastYearMonthDaily: Double? = null
}